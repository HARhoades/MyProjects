...
void Object3D::rotateByX(double dTheta) {
    this->orientation.x += dTheta;
    cout << this->orientation.x;
}
void Object3D::rotateByY(double dTheta) {
    this->orientation.y += dTheta;
    cout << this->orientation.y;
}
void Object3D::rotateByZ(double dTheta) {
    this->orientation.z += dTheta;
    cout << this->orientation.z;
}
